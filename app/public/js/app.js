...
/***/ function(module, exports, __webpack_require__) {
	...
	var _routesRoutes = __webpack_require__(5);
	...
	var AppRoutes = (function (_React$Component) {
	    ...
	    _createClass(AppRoutes, [{
	        ...
	        value: function render() {
	            return _react2['default'].createElement(_reactRouter.Router, { routes: _routesRoutes2['default'],
	                onUpdate: function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsActive_sensorsActive_sensors = __webpack_require__(11);
	
	var _componentsActive_sensorsActive_sensors2 = _interopRequireDefault(_componentsActive_sensorsActive_sensors);
	
	var _componentsTransformation_calculatorCalculator = __webpack_require__(40);
	
	var _componentsTransformation_calculatorCalculator2 = _interopRequireDefault(_componentsTransformation_calculatorCalculator);
	
	var _componentsArchiveArchive = __webpack_require__(41);
	
	var _componentsArchiveArchive2 = _interopRequireDefault(_componentsArchiveArchive);
	...
	exports['default'] = _react2['default'].createElement(
	    ...
	    _react2['default'].createElement(
	        ...
	        { component: _componentsActive_sensorsActive_sensors2['default'] },
	        ' '
	    ),
	    _react2['default'].createElement(_reactRouter.Route, { path: '/calculator', component: _componentsTransformation_calculatorCalculator2['default'] }),
	    _react2['default'].createElement(_reactRouter.Route, { path: '/archives', component: _componentsArchiveArchive2['default'] }),
	    ...
	    _createClass(Dashboard, [{
	        ...
	        value: function render() {
	            ...
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(_Header2['default'], { root: this.props.props.route.path }),
	                _react2['default'].createElement(
	                    'div',
	                ...
	                _react2['default'].createElement(
	                    ...
	                    _react2['default'].createElement(
	                        ...
	                        _react2['default'].createElement(
	                            ...
	                            _react2['default'].createElement(
	                                _reactRouter.Link,
	                                { to: '/calculator', onClick: this.toggleCollapse.bind(this) },
	        ...
	        value: function render() {
	            ...
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    ...
	                    _react2['default'].createElement(
	                        _reactRouter.IndexLink,
	                        { style: linkStyle, to: this.props.root },
	                        'Panopticon'
	                    )
	                )
	            );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _commonSearchBar = __webpack_require__(12);
	
	var _commonSearchBar2 = _interopRequireDefault(_commonSearchBar);
	
	var _Robot = __webpack_require__(13);
	
	var _Robot2 = _interopRequireDefault(_Robot);
	
	var _commonList = __webpack_require__(14);
	...
	var Live = (function (_React$Component) {
	    ...
	    _createClass(Live, [{
	        ...
	        key: 'initRobots',
	        value: function initRobots(robot) {
	            var hostname = robot.hostname;
	            var ip = robot.ip_address;
	            return _react2['default'].createElement(_Robot2['default'], _extends({ hostname: hostname, ip: ip }, robot));
	        }
	    }, {
	        ...
	        value: function componentDidMount() {
	            ...
	            axios.get('/api/get-robots', {
	                ...
	                var robs = response.data.map(_this.initRobots);
	                _this.setState({
	                    robots: robs,
	                    filteredRobots: robs
	                });
	        ...
	        value: function getRobots() {
	            axios.get('/api/get-robots', {
	                ...
	                var robs = response.data.map(this.searchFilter);
	                this.setState({
	                    robots: robs,
	                    filteredRobots: robs
	                });
	        ...
	        value: function searchFilter() {
	            ...
	            var filtered = this.state.robots.filter(function (datum) {
	                var robot = datum.props;
	                console.log(robot);
	        ...
	        value: function render() {
	            ...
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    ...
	                    _react2['default'].createElement(
	                        'h3',
	                        { className: 'title', style: headerStyle },
	                        'Active Sensors'
	                    )
	                ),
	                _react2['default'].createElement(
	                    'div',
	                    { className: 'container', style: containerStyle },
	                    _react2['default'].createElement(_commonSearchBar2['default'], { value: this.state.search, onChange: this.updateSearch.bind(this) })
	                ),
	                _react2['default'].createElement(
	                    'section',
	                    { className: 'section-content' },
	                    _react2['default'].createElement(_commonList2['default'], { items: this.state.filteredRobots, itemType: _Robot2['default'] })
	                )
	            );
	        }
	    }], [{
	    ...
	    _createClass(Robot, [{
	        ...
	        value: function render() {
	            ...
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement('img', { className: 'icon', style: img_style, src: robot.icon }),
	                _react2['default'].createElement(
	                    'div',
	    ...
	    _createClass(List, [{
	        ...
	        value: function createItemsMarkup(items, Type) {
	            var markupItems = items.map(function (item) {
	                return _react2["default"].createElement(
	                    "li",
	                    { className: "ui-list-item", key: item._id },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var VectorItems = (function (_React$Component) {
	    _inherits(VectorItems, _React$Component);
	
	    function VectorItems() {
	        _classCallCheck(this, VectorItems);
	
	        _get(Object.getPrototypeOf(VectorItems.prototype), 'constructor', this).apply(this, arguments);
	    }
	
	    _createClass(VectorItems, [{
	        key: 'render',
	        value: function render() {
	            var vectorEntries = this.props.entries;
	
	            function createTasks(item) {
	                var output = '{' + item.textPre + '},     ' + '{' + item.textPost + '}';
	                return _react2['default'].createElement(
	                    'li',
	                    { key: item.key },
	                    output
	            ...
	            var listItems = vectorEntries.map(createTasks);
	...
	var VectorList = (function (_React$Component2) {
	    _inherits(VectorList, _React$Component2);
	
	    function VectorList(props) {
	        _classCallCheck(this, VectorList);
	
	        _get(Object.getPrototypeOf(VectorList.prototype), 'constructor', this).call(this, props);
	    ...
	    _createClass(VectorList, [{
	        ...
	        value: function render() {
	            ...
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    ...
	                    _react2['default'].createElement(
	                        ...
	                        _react2['default'].createElement(
	                            'h4',
	                            { style: text_style },
	                            ' Given two pairs of corresponding cartesian points, calculate the optimal tranlation and rotation between them. The calculator will (soon) implement the following algorithm:'
	                        ),
	                        _react2['default'].createElement(
	                            'ul',
	                            { style: listStyle },
	                            _react2['default'].createElement(
	                                'li',
	                                null,
	                                'Check that given input matrices are of the same dimension.'
	                            ),
	                            _react2['default'].createElement(
	                                'li',
	                                null,
	                                'Calculate the centroid for each matrix, i.e. take the average of the rows, and return the result as a vector.'
	                            ),
	                            _react2['default'].createElement(
	                                'li',
	                                null,
	                                'From each row in each matrix, subtract the centroid. In effect, shift each set so that it\'s centroid is at the origin. '
	                            ),
	                            _react2['default'].createElement(
	                                'li',
	                                null,
	                                'Calculate a third matrix H as the product of the pre and post translation matrices'
	                            ),
	                            _react2['default'].createElement(
	                                'li',
	                                null,
	                                'Take the singular value decomposition of H'
	                            ),
	                            _react2['default'].createElement(
	                                'li',
	                                null,
	                                'Display the optimal transformation calcualted.'
	                            )
	                        )
	                    ),
	                    _react2['default'].createElement('div', { className: 'col-md-3' })
	                    ...
	                    _react2['default'].createElement(
	                        ...
	                        _react2['default'].createElement(
	                            ...
	                            _react2['default'].createElement(
	                                ...
	                                _react2['default'].createElement('input', { style: inputStyle, ref: function (a) {
	                                        return _this._inputPre = a;
	                                    },
	                                    placeholder: 'Pre Vector' }),
	                                _react2['default'].createElement('input', { style: inputStyle, ref: function (a) {
	                                        return _this._inputPost = a;
	                                    },
	                ...
	                _react2['default'].createElement(VectorItems, { entries: this.state.items })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactNotification = __webpack_require__(43);
	            ...
	            return this.setState({
	                ...
	                notifications: notifications.add({
	                    ...
	                    onClick: function onClick() {
	                        return _this.removeNotification(newCount);
	                    }
	                })
	            });
	        }
	                    ...
	                    _react2['default'].createElement(
	                        ...
	                        _react2['default'].createElement(
	                            ...
	                            _react2['default'].createElement(
	                                'div',
	                                { className: 'col-md-4' },
	                                _react2['default'].createElement('input', { id: 'textinput', name: 'textinput',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _notificationStack = __webpack_require__(46);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _defaultPropTypes = __webpack_require__(45);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stackedNotification = __webpack_require__(47);
